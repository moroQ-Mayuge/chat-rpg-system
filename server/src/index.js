...
import { propCategoriesRouter } from './routes/propCategories.js';
...
import { poseMastersRouter } from './routes/poseMasters.js';
import { mobFlavorPresetsRouter } from './routes/mobFlavorPresets.js';
import { mobNamePresetsRouter } from './routes/mobNamePresets.js';
import { mobSurnamePresetsRouter } from './routes/mobSurnamePresets.js';
import { relationshipAxesRouter } from './routes/relationshipAxes.js';
import { charactersRouter } from './routes/characters.js';
import { outfitsRouter } from './routes/outfits.js';
import { outfitMastersRouter } from './routes/outfitMasters.js';
import { characterTransformationsRouter } from './routes/characterTransformations.js';
...
import { modelEvalsRouter } from './routes/modelEvals.js';
...
app.use('/api/prop-categories', propCategoriesRouter);
...
app.use('/api/pose-masters', poseMastersRouter);
app.use('/api/mob-flavor-presets', mobFlavorPresetsRouter);
app.use('/api/mob-name-presets', mobNamePresetsRouter);
app.use('/api/mob-surname-presets', mobSurnamePresetsRouter);
app.use('/api/relationship-axes', relationshipAxesRouter);
app.use('/api/characters', charactersRouter);
app.use('/api', outfitsRouter);
app.use('/api/outfit-masters', outfitMastersRouter);
app.use('/api', characterTransformationsRouter);
app.use('/api/playthroughs', playthroughsRouter);
app.use('/api/room-sessions', roomSessionsRouter);
app.use('/api', eventsRouter);
app.use('/api/settings', settingsRouter);
app.use('/api/model-evals', modelEvalsRouter);
