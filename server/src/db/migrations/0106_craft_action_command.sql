-- command_type の CHECK 制約に 'craft' を追加するため、0094と同じ
...
CREATE TABLE action_commands_new (
  ...
  command_type TEXT NOT NULL CHECK (command_type IN ('keyword', 'item_pickup', 'item_check', 'item_use', 'item_wear', 'transform_request', 'free_text', 'craft')),
